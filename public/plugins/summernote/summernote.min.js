...
!function (a) {
    ...
    }, n = String.fromCharCode(160), o = "\ufeff", p = function () {
        var b = function (b) {
    ...
    var r = function (b, c, d, e) {
        ...
        b && b.tooltip && a.attr({title: b.tooltip}).tooltip({
            container: "body",
            trigger: "hover",
            placement: "bottom"
        })
    ...
    var K, L = function () {
        ...
        var b = function (a, b) {
            ...
            for (c = 0; c < h.length; c++)if (!p.isText(h[c])) {
        ...
        this.fromNode = function (a) {
            ...
            if (h && h.style["line-height"])d["line-height"] = h.style.lineHeight; else {
        ...
        this.insertOrderedList = function (a) {
            ...
            return a.each(b, function (b, f) {
                var g = d.head(f), h = d.last(f), i = c ? p.lastAncestor(g, p.isList) : g.parentNode, j = i.childNodes.length > 1 ? p.splitTree(i, {
                    node: h.parentNode,
                    offset: p.position(h) + 1
                }, {isSkipPaddingBlankHTML: !0}) : null, k = p.splitTree(i, {
                    node: g.parentNode,
                    offset: p.position(g)
        ...
        this.insertTab = function (a, b) {
            ...
            if (f) {
                ...
                if (p.isEmpty(f) && p.isPara(f) && p.isBlockquote(f.parentNode))p.insertAfter(f, f.parentNode), e = f; else {
    ...
    var X = function (a) {
        ...
        this.initialize = function () {
            ...
            i.css({
                width: l.c + "em",
                height: l.r + "em"
            }), g.data("value", l.c + "x" + l.r), 3 < l.c && l.c < h.insertTableMaxSize.col && j.css({width: l.c + 1 + "em"}), 3 < l.r && l.r < h.insertTableMaxSize.row && j.css({height: l.r + 1 + "em"}), f.html(l.c + " x " + l.r)
        }
    }, ea = function (b) {
        ...
        this.createShortCutList = function () {
            ...
            var b = f.dialogsInBody ? a(document.body) : e, c = ['<p class="text-center">', '<a href="//summernote.org/" target="_blank">Summernote 0.8.1</a> · ', '<a href="//github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = d.dialog({
